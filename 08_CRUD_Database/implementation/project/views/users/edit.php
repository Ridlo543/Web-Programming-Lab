...
<form action="update/<?= $user['id']; ?>" method="POST" class="space-y-4 max-w-md">
    <div>
    ...
    <div>
        ...
        <input type="email" name="email" value="<?= htmlspecialchars($user['name']); ?>" required class="w-full px-3 py-2 border rounded focus:outline-none focus:ring-2 focus:ring-blue-500">
    </div>
